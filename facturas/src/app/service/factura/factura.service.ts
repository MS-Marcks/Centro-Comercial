...
export class FacturaService {
  ...
  private urlbase = 'https://www.apicomercial.pvivirtual.com/api/usuario/factura';
  private urlbaseCliente = 'https://www.apicomercial.pvivirtual.com/api/usuario/cliente';
